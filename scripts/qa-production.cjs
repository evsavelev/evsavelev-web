...
must(home.includes('styles.css?v=20260925-3'), 'home CSS cache bust');
must(home.includes('app.js?v=20260925-3'), 'home app JS cache bust');
must(home.includes('request.js?v=20260925-3'), 'home request JS cache bust');
must(projects.includes('../styles.css?v=20260925-3'), 'projects CSS cache bust');
must(projects.includes('../app.js?v=20260925-3'), 'projects app JS cache bust');
must(home.includes('kinder-party-dom-nizhnevartovsk-720.webp?v=20260925-3'), 'Kinder Party thumbnail cache bust');
