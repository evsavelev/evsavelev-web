...
## Promo / скидка до 31.12.2026
- Коммерческая цель: ускорить набор первых платных клиентов и новых кейсов.
- Реальное условие от владельца: скидка 50% на все форматы разработки до 31 декабря 2026.
- В hero использовать компактную промо-панель, а не агрессивный баннер: срок → размер скидки → переход к ценам.
- В pricing показывать одновременно обычную цену и действующую цену, обычную — зачёркнутой.
- Текущие цены: лендинг от 17 500 ₽; сайт компании от 30 000 ₽; корпоративный сайт от 50 000 ₽; сайт-каталог от 65 000 ₽; индивидуальный проект от 80 000 ₽.
- Не использовать искусственный дефицит, таймер обратного отсчёта, «осталось N мест» или иные факты, которых пользователь не предоставлял.
- Бесплатное персональное демо 0 ₽ остаётся отдельным входом в воронку и не подменяет акционную цену.


## Ultra-wide / browser zoom 80%
- Реальный пользовательский сценарий: desktop Chrome при масштабе 80%, что даёт CSS viewport около 1900–2100 px.
- Проверка обязательна на 1600, 1920 и 2048 px, а не только на 1440.
- На ширине >=1600 контейнер расширяется до 1680 px, на >=1900 — до 1760 px, чтобы не появлялись чрезмерные пустые поля.
- Вертикальный ритм на ultra-wide плотнее: секции ~82–88 px, hero без искусственной высоты viewport, process/capability/about/final CTA компактнее.
- Мобильные и стандартные desktop размеры не должны меняться из-за ultra-wide override.
